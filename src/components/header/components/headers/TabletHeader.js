...
export const TabletHeader = ({ loggedInUser, logOutSuccess, doLogout, doResetLogoutState }) => {
            ...
            <CHeader position="sticky" className="border-bottom-0">
                <CContainer className="d-flex justify-content-between">
                    <div className="d-flex justify-content-around w-25">
                        <CHeaderBrand href="#">
                            <CImage fluid src={logo} style={{ width: "100%" }} />
                        </CHeaderBrand>
                    </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TabletHeader)
